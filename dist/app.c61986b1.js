...
var store = {
  currentPage: 1,
  feeds: []
}; // const ajaxFetch = fetch('https://api.hnpwa.com/v0/news/1.json').then((response) => response.json());
// console.log('ajaxFetch ::: ', ajaxFetch);
...
function makeFeeds(feeds) {
  for (var i = 0; i < feeds.length; i++) {
    feeds[i].read = false; // store객체의 feeds배열에 read: false라는 값을 추가
  }
...
function newsDetail() {
  ...
  console.log("location.hash id ::::", id);
